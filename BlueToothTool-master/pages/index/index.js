...
Page({
  ...
  onLoad: function(options) {
    ...
    let senddata = '68101027000000000014c8008b16'

    let buffer11 = new ArrayBuffer(senddata.length)

    let dataView = new DataView(buffer11)
    ...
    var order =""
    var orderStr ="68100000010000000014C316"
    var orderStr1 ="681007000200000000a40400000029160000"
    var A = orderStr1.substring(0, 36)
    console.log(A)
    var typedArray = new Uint8Array(orderStr1.match(/[\da-f]{2}/gi).map(function (h) {
      var c =parseInt(h, 16)
      return c 
    }))
    ...
    var number =0
    for (let i = 0; i < (orderStr1.length-4);i++){
      if(i%2!=1){
        var b = orderStr1.substr(i,2)
        number += +parseInt("0x"+b)
      }
    }
    console.log(number)
    console.log((number & (parseInt("ff", 16))).toString(16))
    ...
    wx.getBLEDeviceServices({
      ...
      success: function(res) {
        ...
        // for (let i = 0; i < res.services.length; i++) {
          ...
          console.log(222)
          var i = 1
          // if (res.services[i].uuid.indexOf("FFE0")!="-1") { //该服务是否为主服务
            // console.log(res.services[i].uuid)
          console.log(222222)
